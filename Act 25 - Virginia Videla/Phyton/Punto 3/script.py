...
def cargar():
    ...
    for i in range(4):
        nombre = input(f"Escriba el nombre del piloto {i+1}: ")
        tiempo1 = float(input("Escriba el tiempo de la vuelta 1: "))
        tiempo2 = float(input("Escriba el tiempo de la vuelta 2: "))
        tiempo3 = float(input("Escriba el tiempo de la vuelta 3: "))
...
def mejorvuelta(pilotos):
    ...
    print("Mejor vuelta:")
    print("Piloto:", mejorpiloto)
    print("Tiempo:", mejortiempo, "segundos")
