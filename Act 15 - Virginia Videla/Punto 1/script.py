...
for x in range(4):
    nombrealumno = input(f"Escriba el nombre del alumno {x+1}: ")
    nombre.append(nombrealumno)

    notaalumno = int(input(f"Escriba la nota del alumno {x+1}: "))
    nota.append(notaalumno)
